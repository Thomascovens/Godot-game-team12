...
func _ready() -> void:
	...
	$AnimatedSprite2D.play("lightning_fly")
...
func _trigger_impact() -> void:
	...
	$AnimatedSprite2D.sprite_frames.set_animation_loop("lightning_on_impact", false)
	$AnimatedSprite2D.play("lightning_on_impact")

func _on_animation_finished() -> void:
	if $AnimatedSprite2D.animation == "lightning_on_impact":
		queue_free()
